...
public abstract class RSAUtils {
    ...
    public static String decryptString(PrivateKey privateKey, String encrypttext) {
        ...
        try {
            ...
            LOGGER.error(String.format("\"%base\" Decryption failed. Cause: %base", encrypttext, ex.getCause().getMessage()));
        }
        return null;
    }
    ...
    public static String decryptString(String encrypttext) {
        ...
        try {
            ...
            LOGGER.error(String.format("\"%base\" Decryption failed. Cause: %base", encrypttext, ex.getMessage()));
        }
        return null;
    }
